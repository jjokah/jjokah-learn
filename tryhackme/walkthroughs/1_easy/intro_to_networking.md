...
![osi-model](https://muirlandoracle.co.uk/wp-content/uploads/2020/02/OSI-Table.png)
...
7. Which layer handles logical addressing? Answer with the number of the layer: e.g. if the answer would be "the application layer", then you would enter "7".
> 3

8. When sending data over TCP, what would you call the "bite-sized" pieces of data? 
> Segments

9. [Research] Which layer would the FTP protocol communicate with? Answer with the number of the layer: e.g. if the answer would be "the application layer", then you would enter "7".
> 7

10. Which transport layer protocol would be best suited to transmit a live video? 
> UDP
